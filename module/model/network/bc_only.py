"""BC-only model support."""

import pytorch_lightning as pl
import torch


class OnlyBC(pl.LightningModule):
    """Single-input BC enhancement model."""
    ...
    def _prepare_batch(self, batch):
        ...
        reference_speech, _, bc_speech = cut_batch
        return reference_speech, bc_speech

    def forward(self, ac, bc):
        return self.generator(bc)
